...
Docker에서는 Travel MCP, Backend, Frontend를 함께 실행합니다. Policy MCP는
Backend 컨테이너가 stdio 자식 프로세스로 실행합니다.
...
- Backend API 문서: http://localhost:8003/docs
- Travel MCP: http://localhost:8013/mcp

이미 실행 중인 `mini_agent_01_llm`의 8000·8501 포트와 충돌하지 않도록
외부 포트는 8003·8503·8013을 사용합니다. 컨테이너 내부 통신 포트는 각각
8000·8501·8010입니다.
